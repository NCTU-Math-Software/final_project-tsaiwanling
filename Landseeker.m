...
%if you open the bomb then the game over
    ...
    switch v
        case 1
            D=11;B=10;
            figure('Name','Landmine','outerposition',[400 150 700 700]);
            set (gca,'position',[0.001,0.001,0.9999,0.9999]),axis([0 D 0 D]);axis off;hold on;
        case 2
            D=18;B=40;
            figure('Name','Landmine','outerposition',[400 50 800 800]);
            set (gca,'position',[0.001,0.001,0.9999,0.9999]),axis([0 D 0 D]);axis off;hold on;
        case 3
            D=26;B=99;
            figure('Name','Landmine','outerposition',[400 50 800 800]);
